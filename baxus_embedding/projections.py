...
from baxus_embedding.baxus_configuration import EmbeddingType
from baxus_embedding.data_utils import right_pad_sequence
from baxus_embedding.exceptions import (OutOfBoundsException,
...
class AxUS(ProjectionModel):
    ...
    def _reset(self):
        ...
        if self.target_dim == self.input_dim:
            ...
            if self.bin_sizing == EmbeddingType.BAXUS:
                ...
                input_dim_bins = right_pad_sequence(input_dim_bins, dtype=int)
    ...
    def increase_target_dimensionality(self, dims_and_bins: Dict[int, int]):
        ...
        for splitting_target_dim, n_new_bins in dims_and_bins.items():
            ...
            new_bins_padded = right_pad_sequence(new_bins, dtype=int)
